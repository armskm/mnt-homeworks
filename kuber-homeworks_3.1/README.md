...
Итого наш кластер состоит из одной мастер-ноды (8 ГБ RAM и 4 ядер CPU) и восьми рабочих (worker) нод (16   ГБ RAM и 4 ядер CPU).
...
- 2 мастер-ноды (8 ГБ RAM и 4 ядер CPU);
